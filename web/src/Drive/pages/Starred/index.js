...
function isStarred(file) {
  return file?.starred === true || file?.isStarred === true;
}

export default function StarredView({ user }) {
  ...
  const visibleFiles = useMemo(() => {
    const starred = files.filter(isStarred);
    return applySort(starred, sortBy, folderPosition);
