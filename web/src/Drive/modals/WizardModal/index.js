...
function TutorialOverlay({ active }) {
  ...
  return createPortal(<div className="tutorial-overlay" />, document.body);
}
...
const Step2 = ({ onNext, onBack }) => {
  return (
    <div className="wizard-step">
      ...
      <p>
        You can create folders, files, and upload content from your personal
        device with the new button.
      </p>
      <button className="wizard-button" onClick={onBack}>
        Back
      </button>
      <button className="wizard-button" onClick={onNext}>
        Next
...
const Step3 = ({ onNext, onBack }) => (
  <div className="wizard-step">
    ...
    <p>
      You can change settings and preferences in the settings menu located at
...
const Step4 = ({ onNext, onBack }) => (
  <div className="wizard-step">
    ...
    <p>
      You can also right click inside the file area to add new files or folders
...
const Step5 = ({ onNext, onBack }) => (
  <div className="wizard-step">
    ...
    <p>
      You can use the search bar at the top to quickly find files and folders.
    </p>
    <button className="wizard-button" onClick={onBack}>
      Back
    </button>
...
const Step6 = ({ onFinish, onBack }) => (
  <div className="wizard-step">
    ...
    <button className="wizard-button" onClick={onFinish}>
      Finish
    </button>
  </div>
);
...
function WizardModal({ onComplete }) {
  ...
  const renderBody = (isOpen, shouldRender, close) => {
    ...
    return <div className="wizard-modal">{renderStep(close)}</div>;
  };
